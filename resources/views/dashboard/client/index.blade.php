    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.clients') }}</span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="mb-3 mb-xl-0">
                <a href="{{ route('clients.create') }}" class="btn btn-primary">
                {{ __('dashboard.create_client') }} <i class="mdi mdi-plus"></i>
                </a>
            </div>
        </div>
    </div>
                                ...
                                @if(isset($clients) && $clients!=null)
                                    @foreach($clients as $client)
                                        <tr>
                                            ...
                                            <td> 
                                                <a href="{{ route('clients.show', $client->id) }}" class="btn btn-sm btn-primary"> <i class="las la-eye"></i> </a> 
                                                <a href="{{ route('clients.edit', $client->id) }}" class="btn btn-sm btn-info btn-b"> <i class="las la-pen"></i> </a> 
                                                <a href="javascript:void(0)" class="btn btn-sm btn-danger" onclick="event.preventDefault(); document.getElementById('delete-form-{{$client->id}}').submit();"> <i class="las la-trash"></i> </a> 
