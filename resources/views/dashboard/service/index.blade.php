    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.services') }}</span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="mb-3 mb-xl-0">
                <a href="{{ route('services.create') }}" class="btn btn-primary">
                {{ __('dashboard.create_service') }} <i class="mdi mdi-plus"></i>
                </a>
            </div>
        </div>
    </div>
                                ...
                                @if(isset($services) && $services!=null)
                                    @foreach($services as $service)
                                        <tr>
                                            ...
                                            <td> 
                                                <a href="{{ route('services.show', $service->id) }}" class="btn btn-sm btn-primary"> <i class="las la-eye"></i> </a> 
                                                <a href="{{ route('services.edit', $service->id) }}" class="btn btn-sm btn-info btn-b"> <i class="las la-pen"></i> </a> 
                                                <a href="javascript:void(0)" class="btn btn-sm btn-danger" onclick="event.preventDefault(); document.getElementById('delete-form-{{$service->id}}').submit();"> <i class="las la-trash"></i> </a> 
