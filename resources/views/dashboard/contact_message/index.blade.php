    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.contact_messages') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                ...
                                @if(isset($contact_messages) && $contact_messages!=null)
                                    @foreach($contact_messages as $contact_message)
                                        <tr>
                                            ...
                                            <td> 
                                                <a href="{{ route('contact-messages.show', $contact_message->id) }}" class="btn btn-sm btn-primary"> <i class="las la-eye"></i> </a> 
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
