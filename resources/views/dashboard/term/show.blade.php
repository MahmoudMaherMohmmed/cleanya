    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('dashboard.terms_and_conditions_details') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <table class="table table-striped mg-b-0 text-md-nowrap">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$terms_and_condition->created_at->diffForHumans()}}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div><!-- bd -->
